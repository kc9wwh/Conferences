...
# end-user for their password to reissue a FileVault Key
#
#
# OBJECTIVES
...
userPass="$(/bin/launchctl asuser ${userID} "$cdPath" secure-standard-inputbox --informative-text "Please enter your login password:" --title "Mac Encryption Update - Renew Recovery Key" --no-cancel --float)"
userPass="$(echo ${userPass} | awk '{print $2}')" 
